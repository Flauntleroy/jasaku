...
<html lang="id">
  <head>
    ...
    <title>Lupa Password - Sistem Tanda Tangan Digital Jasa/Bonus</title>
      ...
      <div class="flex-1 flex items-center justify-center p-8 bg-white dark:bg-gray-900 transition-colors duration-300">
        <div class="w-full max-w-md animate-slide-up">
          ...
          <div class="text-center mb-8">
            <div class="inline-flex items-center justify-center w-16 h-16 bg-teal-500/10 rounded-2xl mb-6">
          ...
          <div class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 p-8 shadow-lg animate-scale-in">
            ...
            <form class="space-y-6" method="post" action="<?= site_url('auth/forgot_password') ?>">
              ...
              <div class="space-y-2">
                ...
                <p class="text-xs text-gray-500 dark:text-gray-400">Masukkan nomor WhatsApp yang terdaftar</p>
              </div>
            ...
            <form class="space-y-6" method="post" action="<?= site_url('auth/forgot_password') ?>">
              ...
              <input type="hidden" name="phone" value="<?= isset($phone) ? html_escape($phone) : '' ?>">
              ...
              <div class="space-y-2">
                <label class="text-sm font-medium text-gray-700 dark:text-gray-300 block">
                  Kode Reset <span class="text-red-500">*</span>
                </label>
                <div class="relative group">
                  <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                    <svg class="w-5 h-5 text-gray-400 group-focus-within:text-brand-500 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <p class="text-xs text-gray-500 dark:text-gray-400">Masukkan kode 6 digit yang dikirim ke WhatsApp Anda</p>
              </div>
              ...
              <div class="text-center">
                <a href="<?= site_url('auth/forgot_password') ?>" class="text-sm text-brand-500 hover:text-brand-600 font-medium hover:underline transition-all">
                  Kirim ulang kode
                </a>
              </div>
            </form>
            ...
            <div class="text-center mt-6">
              <p class="text-sm text-gray-500 dark:text-gray-400">
                Sudah ingat? 
                <a href="<?= site_url('auth/login') ?>" class="text-brand-500 hover:text-brand-600 font-medium hover:underline transition-all">
                  Kembali ke Login
                </a>
              </p>
            </div>
