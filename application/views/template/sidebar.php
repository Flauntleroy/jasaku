      ...
      <div>
        ...
        <ul class="flex flex-col gap-4 mb-6">
          <?php if ($role === 'admin'): ?>
            <li>
              <a href="<?= base_url('admin/dashboard') ?>" class="flex items-center gap-3 rounded-lg px-3 py-2 text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-white/5 <?= uri_string()==='admin/dashboard'?'bg-gray-100 dark:bg-white/5 font-medium':'' ?>">
                <svg class="h-5 w-5 text-gray-500 dark:text-gray-400" viewBox="0 0 24 24" fill="currentColor"><path d="M3 13h8V3H3v10zm0 8h8v-6H3v6zm10 0h8V11h-8v10zm0-18v6h8V3h-8z"/></svg>
            ...
            <li>
              <a href="<?= base_url('admin/users') ?>" class="flex items-center gap-3 rounded-lg px-3 py-2 text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-white/5 <?= uri_string()==='admin/users'?'bg-gray-100 dark:bg-white/5 font-medium':'' ?>">
                <svg class="h-5 w-5 text-gray-500 dark:text-gray-400" viewBox="0 0 24 24" fill="currentColor"><path d="M16 11c1.66 0 2.99-1.34 2.99-3S17.66 5 16 5s-3 1.34-3 3 1.34 3 3 3zm-8 0c1.66 0 2.99-1.34 2.99-3S9.66 5 8 5 5 6.34 5 8s1.34 3 3 3zm0 2c-2.67 0-8 1.34-8 4v2h10v-2c0-2.66-5.33-4-8-4zm8 0c-.29 0-.62.02-.97.05 1.16.84 1.97 1.97 1.97 3.45v2H24v-2c0-2.66-5.33-4-8-4z"/></svg>
            ...
            <li>
              <a href="<?= base_url('admin/jasa-bonus') ?>" class="flex items-center gap-3 rounded-lg px-3 py-2 text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-white/5 <?= (uri_string()==='admin/jasa-bonus'||uri_string()==='admin/jasa')?'bg-gray-100 dark:bg-white/5 font-medium':'' ?>">
                <svg class="h-5 w-5 text-gray-500 dark:text-gray-400" viewBox="0 0 24 24" fill="currentColor"><path d="M3 17h18v2H3v-2zm0-5h18v2H3v-2zm0-5h18v2H3V7z"/></svg>
            ...
            <li>
              <a href="<?= base_url('admin/laporan') ?>" class="flex items-center gap-3 rounded-lg px-3 py-2 text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-white/5 <?= uri_string()==='admin/laporan'?'bg-gray-100 dark:bg-white/5 font-medium':'' ?>">
                <svg class="h-5 w-5 text-gray-500 dark:text-gray-400" viewBox="0 0 24 24" fill="currentColor"><path d="M3 3h18v2H3V3zm2 4h14v12H5V7zm4 2v8h2V9H9zm4 0v8h2V9h-2z"/></svg>
          ...
          <?php else: ?>
            ...
            <li>
              <a href="<?= base_url('pegawai/profil') ?>" class="flex items-center gap-3 rounded-lg px-3 py-2 text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-white/5 <?= uri_string()==='pegawai/profil'?'bg-gray-100 dark:bg-white/5 font-medium':'' ?>">
                <svg class="h-5 w-5 text-gray-500 dark:text-gray-400" viewBox="0 0 24 24" fill="currentColor"><path d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z"/></svg>
        ...
        <ul class="flex flex-col gap-4 mb-6">
          <li>
            <a href="<?= base_url('auth/logout') ?>" class="flex items-center gap-3 rounded-lg px-3 py-2 text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-white/5">
              <svg class="h-5 w-5 text-gray-500 dark:text-gray-400" viewBox="0 0 24 24" fill="currentColor"><path d="M10 17l5-5-5-5v3H3v4h7v3zm9-12H12V3h7c1.1 0 2 .9 2 2v14a2 2 0 0 1-2 2h-7v-2h7V5z"/></svg>
